...
/*
Write a function called findInObj which accepts ay, and son array of objects, a keme value to search for and returns the first found value in the array.
...
function removeVowels(str) {
    const chars = str.toLowerCase().split('');
    return chars.filter(char => !isVowel(char)).join('');
}
